...
import type {
  InputSyncingStatus as _apibara_node_v1alpha1_InputSyncingStatus,
  InputSyncingStatus__Output as _apibara_node_v1alpha1_InputSyncingStatus__Output,
} from '../../../apibara/node/v1alpha1/InputSyncingStatus'
