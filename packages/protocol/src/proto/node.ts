...
import type {
  NodeClient as _apibara_node_v1alpha1_NodeClient,
  NodeDefinition as _apibara_node_v1alpha1_NodeDefinition,
} from './apibara/node/v1alpha1/Node'
  ...
  apibara: {
    node: {
      v1alpha1: {
        ...
        Node: SubtypeConstructor<typeof grpc.Client, _apibara_node_v1alpha1_NodeClient> & {
          service: _apibara_node_v1alpha1_NodeDefinition
        }
